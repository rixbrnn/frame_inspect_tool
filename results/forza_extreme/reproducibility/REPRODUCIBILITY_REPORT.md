...
|-----------|-----------------|--------------|-------------------|---------------|
| 1440p | 0.783 | 0.171 | 0.189 | 0.164 |
| 1080p | 0.748 | 0.160 | 0.210 | 0.141 |
| 4K | 0.677 | 0.131 | 0.349 | 0.128 |

### Interpretation

1. **Worst reproducibility:** 4K with SSIM = 0.677
   - Ideal threshold: SSIM ≥ 0.99
   - Observed: SSIM = 0.677 → **32.3% structural dissimilarity**

2. **Implication for DLSS comparisons:**
   - **1440p**: Quality differences < ±0.171 SSIM may be noise
   - **1080p**: Quality differences < ±0.160 SSIM may be noise
   - **4K**: Quality differences < ±0.131 SSIM may be noise
